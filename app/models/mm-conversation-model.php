...
ORDER BY conversation.date DESC";
			...
			$count = $wpdb->get_var( $wpdb->prepare( $sql, get_current_user_id(), MM_Message_Model::UNREAD ) );
...
ORDER BY conversation.date DESC";
			...
			$count = $wpdb->get_var( $wpdb->prepare( $sql, get_current_user_id(), MM_Message_Model::READ ) );
